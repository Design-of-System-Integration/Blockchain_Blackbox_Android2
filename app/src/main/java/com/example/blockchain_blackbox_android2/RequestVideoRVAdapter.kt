...
class RequestVideoRVAdapter(private var videoList: ArrayList<*>, private val activity: AccidentRequestActivity) :
    RecyclerView.Adapter<RequestVideoRVAdapter.ViewHolder>() {
